class UserAuthenticationController < ApplicationController
  ...
  def create
    ...
    @user.sent_follow_requests_count = params.fetch("query_sent_follow_requests_count", @user.sent_follow_requests_count)
    @user.received_follow_requests_count = params.fetch("query_received_follow_requests_count", @user.received_follow_requests_count)
  ...
  def edit_profile_form
    @user = User.find(params[:id])
    if @user.errors.any?
      render 'user_authentication/edit_profile_with_errors'
    else
      render 'user_authentication/edit_profile'
    end
  end
