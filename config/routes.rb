Rails.application.routes.draw do
  ...
  get("/users/:the_username", { :controller => "users", :action => "show", as: "user" })
  ...
  # EDIT PROFILE FORM        
  get "/edit_user_profile/:id", to: "user_authentication#edit_profile_form", as: :edit_user_profile
  get("/users/:id/edit", { :controller => "user_authentication", :action => "edit_profile_form" }) 
